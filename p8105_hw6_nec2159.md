...
```
    ...
    ## The first warning was:
    ## ℹ In argument: `pe_lasso = map2_dbl(lasso_fit, test, rmse)`.
    ## Caused by warning in `predict.lm()`:
    ## ! prediction from rank-deficient fit; attr(*, "non-estim") has doubtful cases
    ## ℹ Run `dplyr::last_dplyr_warnings()` to see the 34 remaining warnings.

    ## # A tibble: 100 × 9
    ##    train    test     .id   lasso_fit main_effects_fit interactions_fit pe_lasso
    ##    <list>   <list>   <chr> <list>    <list>           <list>              <dbl>
    ##  1 <tibble> <tibble> 001   <lm>      <lm>             <lm>                 248.
    ##  2 <tibble> <tibble> 002   <lm>      <lm>             <lm>                 179.
    ##  3 <tibble> <tibble> 003   <lm>      <lm>             <lm>                 191.
    ##  4 <tibble> <tibble> 004   <lm>      <lm>             <lm>                 223.
    ##  5 <tibble> <tibble> 005   <lm>      <lm>             <lm>                 250.
    ##  6 <tibble> <tibble> 006   <lm>      <lm>             <lm>                 243.
    ##  7 <tibble> <tibble> 007   <lm>      <lm>             <lm>                 242.
    ##  8 <tibble> <tibble> 008   <lm>      <lm>             <lm>                 224.
    ##  9 <tibble> <tibble> 009   <lm>      <lm>             <lm>                 178.
    ## 10 <tibble> <tibble> 010   <lm>      <lm>             <lm>                 172.
    ## # ℹ 90 more rows
    ## # ℹ 2 more variables: pe_main_effects <dbl>, pe_interactions <dbl>
